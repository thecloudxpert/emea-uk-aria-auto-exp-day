...
4. Locate the two us-west-1 resources in the Trading AWS / us-west-1 Account/Region and click their respective check boxes.
5. Click **TAGS**.
...
9. Locate the **Cloud Agnostic** > **Machine** Resource Type from the pallet and drag and drop it onto the design canvas.
...
10. In the **Code** pane, locate the **image:** property and click in between the single quotes.  This should present you with the available image mappings to select from.
11. Select the **ubuntu** image from the list.
12. In the **Code** pane, locate the **flavor:** property and click in between the single quotes.  This should present you with the available flavor mappings to select from.
...
> _**Note:**_ \
_There are a number of Constraint properties, including Storage Constraints and Network Constraints. The Constraints property we are looking for is (as of writing this guide, located under the Cloud Config section._
...
5. Click **CLOSE**.
6. At the **Deployments** screen, locate your deployment, click on the **Actions** menu (vertical ellipsis) and click **Delete** to remove the deployment.
...
6. Click the **CREATE** task to view the stages the deployment has gone through.
