...
- [Module 3 - Deploying to Multiple Clouds](#module-3---deploying-to-multiple-clouds)
  ...
  - [Exercises](#exercises)
    ...
    - [Exercise 3 - Creating a Custom Naming Policy](#exercise-3---creating-a-custom-naming-policy)
    - [Exercise 4 - Creating a Single Machine Cloud Template](#exercise-4---creating-a-single-machine-cloud-template)
    - [Exercise 5 - Deploying a Single Machine Cloud Template](#exercise-5---deploying-a-single-machine-cloud-template)
    - [Exercise 6 - Updating the Single Machine Cloud Template](#exercise-6---updating-the-single-machine-cloud-template)
    - [Exercise 7 - Creating a Single Machine AWS Cloud Template](#exercise-7---creating-a-single-machine-aws-cloud-template)
    - [Exercise 8 - Creating a Single Machine Azure Cloud Template](#exercise-8---creating-a-single-machine-azure-cloud-template)
